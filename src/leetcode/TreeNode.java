 ...
 * 2. Treat the complete binary tree as a binary heap, and write down its array form.
 ...
 *
 * The binary search tree (BST) does NOT include binary trees with duplicate (value) node.
 * */
