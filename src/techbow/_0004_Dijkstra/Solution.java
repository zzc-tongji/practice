package techbow._0004_Dijkstra;
...
import unclassified.datastructure.priorityqueue.MyPriorityQueueByArrayList;
...
public class Solution {
  public static void main(String[] args) {
    ...
    MyGraphNodeDijkstra<Integer> node1 = new MyGraphNodeDijkstra<>(1);
    MyGraphNodeDijkstra<Integer> node2 = new MyGraphNodeDijkstra<>(2);
    MyGraphNodeDijkstra<Integer> node3 = new MyGraphNodeDijkstra<>(3);
    MyGraphNodeDijkstra<Integer> node4 = new MyGraphNodeDijkstra<>(4);
    MyGraphNodeDijkstra<Integer> node5 = new MyGraphNodeDijkstra<>(5);
    MyGraphNodeDijkstra<Integer> node6 = new MyGraphNodeDijkstra<>(6);
